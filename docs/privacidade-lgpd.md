...
Agger segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Agger by Dimensa** | BR | Plataforma de seguros (provedor dos dados do usuário) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [agger@mcp.ai](mailto:agger@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
